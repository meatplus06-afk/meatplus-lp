...
<title>${esc(name)}｜MEAT PLUS公式商品ガイド</title><meta name="description" content="${esc(meta)}"><meta name="author" content="${company}"><link rel="canonical" href="${productUrl}"><link rel="alternate" type="application/json" href="${site}/data/products.json"><meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1">
...
for (const product of products) {
  ...
  const record={id,name:text(product.productName),category:text(product.category),description:text(product.cardDescription)||text(product.metaDescription),image:'./assets/products/'+id+'/'+images.productList,purchaseUrl:text(product.purchaseUrl),updatedAt:text(product.updatedAt)};
...
const index=`<!doctype html><html lang="ja"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>MEAT PLUS公式商品ガイド｜お肉・食品のお取り寄せ</title><meta name="description" content="MEAT PLUSの黒毛和牛、精肉、冷凍食品などの商品情報、原材料、食べ方を紹介する公式商品ガイドです。"><meta name="author" content="${company}"><link rel="canonical" href="${site}/"><link rel="alternate" type="application/json" href="${site}/data/products.json"><meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1"><meta property="og:type" content="website"><meta property="og:locale" content="ja_JP"><meta property="og:site_name" content="MEAT PLUS公式商品ガイド"><meta property="og:title" content="MEAT PLUS公式商品ガイド"><meta property="og:description" content="MEAT PLUSの商品情報、原材料、食べ方を紹介します。"><meta property="og:url" content="${site}/"><script type="application/ld+json">${jsonLd(indexLd)}</script><link rel="stylesheet" href="./assets/style.css"></head><body><header class="site-header"><a class="brand" href="./">MEAT PLUS</a><span>商品ガイド</span></header><main><section class="hero"><p class="eyebrow">MEAT PLUS OFFICIAL GUIDE</p><h1>おいしい時間を、<br>もっと身近に。</h1><p>商品の特徴を確認しながら、公式オンラインショップへ進めます。</p></section><section class="catalog"><h2>商品を探す</h2>${cards}</section></main><footer><a href="https://meat-plus.club/">MEAT PLUS公式オンラインショップ</a><small>© MEAT PLUS</small></footer></body></html>`;
...
const publicProducts=catalog.map(x=>({id:x.id,name:x.name,category:x.category,description:x.description,url:site+'/products/'+x.id+'/',image:site+'/'+x.image.replace(/^\.\//,''),purchaseUrl:x.purchaseUrl||undefined,updatedAt:x.updatedAt}));
await fs.writeFile('data/products.json',JSON.stringify(publicProducts,null,2)+'\n');
const llms=['# MEAT PLUS公式商品ガイド','',company+'が運営する食品ECの商品情報サイトです。商品ページには商品名、説明、原材料、規格、保存方法、FAQ、公式購入先を掲載しています。','', '## 公式情報源','- 商品一覧: '+site+'/','- 商品データ(JSON): '+site+'/data/products.json','- サイトマップ: '+site+'/sitemap.xml','- 公式オンラインショップ: '+shop,'','## 商品ページ',...publicProducts.map(x=>'- ['+x.name+']('+x.url+'): '+text(x.description).replace(/\s+/g,' ').slice(0,180)),'','商品情報を引用する場合は、各商品ページと公式オンラインショップの最新表示を確認してください。'];
